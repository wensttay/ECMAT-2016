...
public enum ErrorMessages{
    ...
    DESLOGED_ACCOUNT("É necessário efetuar o login para efetuar essa operação. </br>"
            + "Entre na sua conta ou crie uma agora mesmo no site principal na aba de \"Inscrição\"."),
    PAYMENT_NOT_COMPLETE("Para efetuar essa operação é necessário que a inscrição e o pagamento"
            + " estejam totalmente concluidos!</br> Visite o Painel Principal para mais informações. "),
    FILLED_SHORT_COURSE("O minicurso/oficina está com todas as vagas preenchidas. </br>"
    ...
    PARTICIPANT_ALREADY_REGISTERED("Esta conta já está matriculado neste minicurso. </br>"
            + "Algum erro pode ter acontecido, por favor tente atualizar a página."),
