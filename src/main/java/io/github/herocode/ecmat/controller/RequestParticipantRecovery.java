 ...
 */
@WebServlet(name = "RequestParticipantRecovery", urlPatterns = {"/RequestParticipantRecovery"})
public class RequestParticipantRecovery extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/redefinir_participant.jsp");
