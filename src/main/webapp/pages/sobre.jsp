                    ...
                    <div class="col-md-6 col-sm-6 colum-left">
                        <div class="responsive-container">
                            ...
                            <div class="container-ajust">
                                <img height="216px" width="216px" alt="Símbolodo do IFPB (Instituto Federal de Educação, Ciência e Tecnologia da Paraíba)"
                ...
                <div class="sobre-paragraph col-md-12 col-sm-12 doble-colum img-right">
                    ...
                    <div class="col-md-6 col-sm-6 colum-right">
                        <div class="responsive-container">
                            <div class="dummy"></div>
                            <div class="container-ajust">
                                <img height="216px" width="216px" alt="Símbolo do Terceiro ECMAT (Encontro Cajazeirense de Matemática)"
