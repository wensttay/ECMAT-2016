            ...
            <div class="col-md-12">
                <div class="evento-info-box col-md-4 col-sm-4">
                    <a title="Clique para confirir o calendário de atividades." href="#programacao" class="evento-link default-low-opacity">
                        ...
                        <img alt="Representação ilustrativa de um Calendário" class="evento-info-img medium-margin-bottom off-load" src="img/other/calendario.png"/>
                    </a>
                </div>
                <div class="evento-info-box col-md-4 col-sm-4">
                    <a title="Clique para conferir os contatos e a localização do envento." href="#contato" class="evento-link default-low-opacity">
                        ...
                        <img alt="Representação ilustrativa de um ponto geográfico" class="evento-info-img medium-margin-bottom off-load" src="img/other/posicao.png"/>
                    </a>
                </div>
                <div class="evento-info-box col-md-4 col-sm-4 disabled">
                    <a title="Clique para conferir a página de inscrição." href="#construcao" class="evento-link default-low-opacity">
                        ...
                        <img alt="Representação ilustrativa de um papel de inscrição" class="evento-info-img medium-margin-bottom off-load" src="img/other/inscricao.png"/>
                    </a>
                </div>
            </div>
        </div>
