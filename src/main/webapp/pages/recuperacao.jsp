        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="col-md-12">
                    ...
                    <form id="form-recuperacao" method="POST" class="form-horizontal" style="font-family: arial;"role="form">
                        ...
                        <div class="form-group col-sm-12 col-xs-12">
                            <input type="submit" id="recuperar-senha" style="float: right;" class="btn btn-default" >
                        </div>
                    </form>
                </div>
            </div>
