            ...
            <div class="col-lg-10 col-md-12 col-sm-12 text-justify"> 
                ...
                <div class="criterios">
                    <p class="default-low-color-white-transparence">
                        <img alt="Representação ilustrativa do númeiro 1 em algarismos romanos(Primeiro item)"
                    ...
                    <p class="default-low-color-white-transparence">
                        <img alt="Representação ilustrativa do númeiro 2 em algarismos romanos (Segundo item)" 
                    ...
                    <p class="default-low-color-white-transparence">
                        <img alt="Representação ilustrativa do númeiro 3 em algarismos romanos (Terceiro item)"
                    ...
                    <p class="default-low-color-white-transparence">
                        <img alt="Representação ilustrativa do númeiro 4 em algarismos romanos (Quarto item)"
                ...
                <div class="col-lg-4 col-md-4 col-sm-5">
                    <div class="default-box"> <!-- Open Program-Day-Box -->
                        <a title="Clique aqui para ver o documento de Modelos de Trabalhos"
                           href="https://drive.google.com/open?id=0Bwx-SPHSFVqgQm5DeThZTGhXeU0" target="_blank">
                            ...
                            <div class="col-md-12 col-sm-12 body-img">
                                <div class="text-center">
                                    <img alt="Representação ilustrativa de um documento" 
