            ...
            <div class="col-lg-10 col-md-12 col-sm-12 text-justify"> 
                ...
                <div class="criterios">
                    <p class="default-low-color-white-transparence">
                        <img width="150px" height="150px" alt="Representação ilustrativa do númeiro 1 em algarismos romanos(Primeiro item)"
                    ...
                    <p class="default-low-color-white-transparence">
                        <img width="150px" height="150px" alt="Representação ilustrativa do númeiro 2 em algarismos romanos (Segundo item)" 
                    ...
                    <p class="default-low-color-white-transparence">
                        <img width="150px" height="150px" alt="Representação ilustrativa do númeiro 3 em algarismos romanos (Terceiro item)"
                    ...
                    <p class="default-low-color-white-transparence">
                        <img width="150px" height="150px" alt="Representação ilustrativa do númeiro 4 em algarismos romanos (Quarto item)"
